...
<section id="content">
  ...
  <div class="content">
    ...
    <div id="sortable">
        ...
        <h5>Age: </h5><span>{{Illuminate\Support\Facades\Auth::user()->advisorrelation->ntn}}</span>
        <h5>Passport No: </h5><span>{{Illuminate\Support\Facades\Auth::user()->advisorrelation->cnic}}</span>
        <h5>Home Town: </h5><span>{{Illuminate\Support\Facades\Auth::user()->advisorrelation->brand}}</span>
    ...
    <div class="modal-content card card-image" style="background-image: url('img/modelimg.jpg');">
      ...
      @method('put')
          ...
          <div class="md-form pb-3">
            ...
            <label data-error="wrong" data-success="right" for="Form-pass5">Passport no</label>
          </div>
          <div class="md-form pb-3">
            ...
            <label data-error="wrong" data-success="right" for="Form-pass5">Hometown</label>
          </div>
          <div class="md-form pb-3">
