...
@if ($errors->any())
  ...
  <!-- fieldsets -->
  <fieldset>
    <h2 class="fs-title">Create Guide account</h2>
  ...
  <fieldset>
    ...
    <input type="text" name="cnic" placeholder="Passport No" require/>
    <input type="text" name="brand" placeholder="Hometown" require/>
    <input type="text" name="ntn" placeholder="Age" require/>
