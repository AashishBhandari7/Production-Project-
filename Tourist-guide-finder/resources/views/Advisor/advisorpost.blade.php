					...
					<div class="feature-item">
						...
						<div class="feature-text">
							...
							<div class="room-info-warp">
								<div class="room-info">
									<div class="rf-left">
										<p><i class="fa fa-th-large"></i> {{$postdata->area}} </p>
										<p><i class="fa fa-bed"></i> {{$postdata->bedroom}} </p>
										<p><i class="fa fa-compass"></i>{{$postdata->state}} </p>
									</div>
									<div class="rf-right">
										<p><i class="fa fa-car"></i> {{$postdata->garage}} </p>
										<p><i class="fa fa-bath"></i> {{$postdata->bathroom}} </p>
    ...
    <div class="modal-content card card-image" style="background-image: url('img/modelimg.jpg');">
      <div class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
        ...
        <div class="modal-body">
          ...
          <div class="md-form pb-3">
            <input type="text" name="ownername"value="{{Session('update_post')->ownername}}"  autocomplete="off" placeholder="" id="Form-pass5" class="form-control validate white-text">
