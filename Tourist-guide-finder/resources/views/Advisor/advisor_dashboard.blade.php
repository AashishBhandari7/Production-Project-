  ...
  <div class="content">
    ...
    <form action="{{route('jazz_id')}}" method="post">
        ...
        <div class="md-form ">
          ...
          <label data-error="wrong" data-success="right" for="Form-pass5">Your Credit card number</label>
        </div>
        <div class="md-form ">
          <input type="text" name="jazz_tra_id" id="Form-pass5"  class="form-control validate white-text">
          <label data-error="wrong" data-success="right" for="Form-pass5">Security code (CVV)</label>
        </div>
        <!--Grid row-->
    ...
    @elseif(Illuminate\Support\Facades\Auth::user()->advisorrelation->is_upgrated==1)
       <div class="row d-flex align-items-center mb-4">
            <!--Grid column-->
            <div class="text-center mb-3 col-md-2">
              <button type="submit" id="post" class="btn btn-success btn-block btn-rounded z-depth-1">Post your Details </button>
            </div>
            <!--Grid column-->
        </div>
          <!--Grid row-->
    ...
    <div id="sortable">
      <img src="img/100.jpg" height="700px" width="1200px">
    </div>
  </div>
</section>
      ...
      <div class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
        ...
        <div class="modal-body">
          ...
          <div class="md-form pb-3">
            <input type="text" name="area"  id="Form-pass5" class="form-control validate white-text" placeholder="e.g Aashish Bhandari">
            <label data-error="wrong" data-success="right" for="Form-pass5">Full Name</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="garage" autocomplete="off" placeholder="e.g Kathmandu " id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">Address</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="bath" autocomplete="off" placeholder="e.g 23 " id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">Age</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="bed"  autocomplete="off" placeholder="e.g Pokhara " id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">Preferred Place</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="ownername" autocomplete="off" placeholder="e.g Nepali" id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">Language1</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="rent" autocomplete="off" placeholder="e.g English" id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">Language2</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="city" autocomplete="off" placeholder="e.g German" id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">Other Language</label>
          </div>
          <div class="md-form pb-3">
            <select name="state" style="border-radius: 5px;border: none;padding: 10px 271px 10px 0;">
              <option value="Punjab">5 days</option>
              <option value="Sindh">10 days</option>
              <option value="Kpk">15 days</option>
              <option value="Blochistan">More</option>
            </select> <br>
            <label data-error="wrong" data-success="right" for="Form-pass5">Your expected days </label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="address" autocomplete="off" placeholder="" id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">Phone No</label>
          </div>
          <div class="md-form pb-3">
            <textarea type="text" rows="4" cols="50" autocomplete="off" name="des" id="Form-pass5" class="form-control validate white-text"></textarea>
